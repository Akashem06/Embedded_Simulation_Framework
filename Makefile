...
CLIENT_UTILS_SRCS := $(wildcard $(CLIENT_DIR)/utils/src/*.cc)
...
CLIENT_UTILS_OBJS := $(patsubst $(CLIENT_DIR)/utils/src/%.cc,$(BUILD_DIR)/client/utils/%.o,$(CLIENT_UTILS_SRCS))
...
$(BUILD_DIR)/server/utils/%.o: $(SERVER_UTILS_SRC_DIR)/%.cc | $(BUILD_DIR)
	@echo "Compiling $<"
	$(CPP) $(CPPFLAGS) -I$(SERVER_APP_INC_DIR) -I$(SERVER_UTILS_INC_DIR) -I$(COMMON_INC_DIR) -c $< -o $@

$(BUILD_DIR)/client/app/%.o: $(CLIENT_APP_SRC_DIR)/%.cc | $(BUILD_DIR)
	@echo "Compiling $<"
	$(CPP) $(CPPFLAGS) -I$(CLIENT_APP_INC_DIR) -I$(CLIENT_UTILS_INC_DIR) -I$(COMMON_INC_DIR) -I$(DRIVERS_INC_DIR) -I$(CAN_INC_DIR) -c $< -o $@

$(BUILD_DIR)/client/utils/%.o: $(CLIENT_UTILS_SRC_DIR)/%.cc | $(BUILD_DIR)
	@echo "Compiling $<"
