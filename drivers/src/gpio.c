...
static uint8_t s_gpio_pin_state[GPIO_TOTAL_PINS] = {
    GPIO_STATE_LOW, GPIO_STATE_HIGH, GPIO_STATE_LOW, GPIO_STATE_HIGH,
    GPIO_STATE_LOW, GPIO_STATE_HIGH, GPIO_STATE_LOW, GPIO_STATE_HIGH,
    GPIO_STATE_LOW, GPIO_STATE_HIGH, GPIO_STATE_LOW, GPIO_STATE_HIGH,
    GPIO_STATE_LOW, GPIO_STATE_HIGH, GPIO_STATE_LOW, GPIO_STATE_HIGH,
    GPIO_STATE_LOW, GPIO_STATE_HIGH, GPIO_STATE_LOW, GPIO_STATE_HIGH,
...
static GpioAlternateFunctions s_gpio_alt_functions[GPIO_TOTAL_PINS] = {
    GPIO_ALT_NONE, GPIO_ALT1_TIM1, GPIO_ALT4_I2C1, GPIO_ALT5_SPI1,
    GPIO_ALT7_USART1, GPIO_ALT9_CAN1, GPIO_ALT14_TIM15, GPIO_ALT0_SWDIO,
    GPIO_ALT1_TIM2, GPIO_ALT4_I2C2, GPIO_ALT5_SPI2, GPIO_ALT7_USART2,
    GPIO_ALT_NONE, GPIO_ALT1_TIM1, GPIO_ALT4_I2C3, GPIO_ALT0_SWCLK,
    GPIO_ALT7_USART3, GPIO_ALT9_CAN1, GPIO_ALT14_TIM16, GPIO_ALT_NONE,
    GPIO_ALT1_TIM1, GPIO_ALT4_I2C1, GPIO_ALT5_SPI1, GPIO_ALT7_USART1,
    GPIO_ALT9_CAN1, GPIO_ALT14_TIM15, GPIO_ALT_NONE, GPIO_ALT1_TIM2,
    GPIO_ALT4_I2C2, GPIO_ALT5_SPI2, GPIO_ALT7_USART2, GPIO_ALT_NONE
};
